...
from linear_nets import MLP,fc_layer,fuse_layer
...
class Multimodal_Classifier(ContinualLearner, Replayer, ExemplarHandler):
    ...
    def __init__(self, image_size, image_channels, classes,
        ...
        # fully connected hidden layers for Image
        self.fcE_image = MLP(input_size=image_channels*image_size**2, output_size=fc_units, layers=fc_layers-1,
    ...
    def list_init_layers(self):
        ...
        list = []
        list += self.fcE_image.list_init_layers()
        list += self.fcE_audio.list_init_layers()
        list += self.fuse_layer.list_init_layers()
